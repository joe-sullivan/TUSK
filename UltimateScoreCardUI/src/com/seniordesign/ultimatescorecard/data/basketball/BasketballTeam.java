...
public class BasketballTeam extends Team{
	...
	private void setTeamPlayers(String team){
		if(team.equals("San Antonio Spurs")){
			...
			players.add(new BasketballPlayer("Point Guard 1"));
			players.add(new BasketballPlayer("Shooting Guard 1"));
			players.add(new BasketballPlayer("Center 1"));
			players.add(new BasketballPlayer("Power Forward 1"));
			players.add(new BasketballPlayer("Small Forward 1"));
			players.add(new BasketballPlayer("Point Guard 2"));
			players.add(new BasketballPlayer("Shooting Guard 2"));
			players.add(new BasketballPlayer("Center 2"));
			players.add(new BasketballPlayer("Power Forward 2"));
			players.add(new BasketballPlayer("Small Forward 2"));
		}
	}
