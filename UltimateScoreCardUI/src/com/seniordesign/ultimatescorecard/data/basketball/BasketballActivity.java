...
public class BasketballActivity extends Activity{
	...
	private boolean _gameType = true;
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.nextPeriod:
			...
			if(zeroTime()){
				...
				else if(quarter.equals("2ND") && _gameType){
					((TextView)findViewById(R.id.periodNumber)).setText("3RD");
				}
				else if(quarter.equals("2ND") && !_gameType){
					((TextView)findViewById(R.id.periodNumber)).setText("OT");
				}
				else if(quarter.equals("3RD") && _gameType){
					((TextView)findViewById(R.id.periodNumber)).setText("4TH");
				}
				else if(quarter.equals("4TH") && _gameType){
					((TextView)findViewById(R.id.periodNumber)).setText("OT");
				}
				else{
