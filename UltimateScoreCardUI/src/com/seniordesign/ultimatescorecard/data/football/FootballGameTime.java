...
public class FootballGameTime extends GameTime{
	...
	public void setLineOfScrimmage (int viewNum){
		...
		//if fourth down conversion fails, change possession and other stuff
		if (_downDistance[0] > 4){
			changePossession();
			_downDistance[0] = 1;
			_downDistance[1] = 10;
			...
			Log.e("DOWN DISTANCE", _downDistance[0]+" and "+_downDistance[1] + " for (" +getPossession()+")");
		}
	}
