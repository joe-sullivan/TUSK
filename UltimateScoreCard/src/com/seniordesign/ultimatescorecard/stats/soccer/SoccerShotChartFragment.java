...
public class SoccerShotChartFragment extends Fragment{
	...
	public void onResume() {
		...
		ArrayList<ShotChartCoords> homeShots = ((SoccerStatsActivity) getActivity()).getHomeShotChart();
		ArrayList<ShotChartCoords> awayShots = ((SoccerStatsActivity) getActivity()).getAwayShotChart();
	...
	private void changeShotChart(){
		if(_showHomeShotChart){
			...
			String awayAbbv = ((SoccerStatsActivity) getActivity()).getGameInfo().getAwayTeam().getabbv();
			...
			String homeAbbv = ((SoccerStatsActivity) getActivity()).getGameInfo().getHomeTeam().getabbv();
...
//----------------------------------------------------------------------------------------------------------	
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		switch(item.getItemId()){
			case R.id.boxscore:
				((SoccerStatsActivity)getActivity()).getPager().setCurrentItem(0);
				break;				
			case R.id.play_by_play:
				((SoccerStatsActivity)getActivity()).getPager().setCurrentItem(1);
				break;
		}
		return true;
	}
